...
sap.ui.define([
	...
	"demo/sap/proj_worklist1/test/flpSandbox"
	...
	return Opa5.extend("demo.sap.proj_worklist1.test.integration.arrangements.FLP", {
		/**
		...
		iRestartTheAppWithTheRememberedItem: function (oOptions) {
			this.waitFor({
				success: function () {
					...
					oOptions.hash = "ZDEMO_C_Pro_TP_D/" + encodeURIComponent(sObjectId);
