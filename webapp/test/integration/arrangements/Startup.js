sap.ui.define([
	"sap/ui/test/Opa5",
	"demo/sap/proj_worklist1/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function (Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("demo.sap.proj_worklist1.test.integration.arrangements.Startup", {
		...
		iRestartTheAppWithTheRememberedItem: function (oOptions) {
			this.waitFor({
				success: function () {
					...
					oOptions.hash = "ZDEMO_C_Pro_TP_D/" + sObjectId;
